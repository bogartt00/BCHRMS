...
<head>
    ...
    <title>Department of Medical Technology</title>
...
<body>
    ...
    <!-- Main content for the Department of MT -->
    <div class="main-content">
        <div class="container mt-5">
            <h1>Department of Medical Technology</h1>
            <p>Health-related data for the MT Department:</p>
