...
$stmt = $conn->prepare("
    ...
    FROM students 
    WHERE deleted_at IS NULL -- Exclude soft-deleted students
    AND (first_name LIKE :query OR last_name LIKE :query OR department LIKE :query)
    ...
    <div class="main-content">
        <div class="container mt-5">
            ...
            <form method="get" action="" class="mb-3">
                <input type="text" class="form-control" name="query" value="<?php echo htmlspecialchars($query); ?>" placeholder="Search by name or department">
